...
describe('DoroClicker', () => {
  ...
  beforeAll(() => {
    ...
    mockAutoclickers = require('../../src/scripts/Systems/autoclickers.js').autoclickers;
  ...
  describe('constructor', () => {
    it('should initialize with correct autoclickers data', () => {
      expect(doroClicker.autoclickers).toEqual(expect.arrayContaining([
    ...
    it('should initialize with correct upgrades data', () => {
      expect(doroClicker.upgrades).toEqual(expect.arrayContaining([
        expect.objectContaining({
          id: 1,
          name: "Doro Power",
          baseCost: 10
    ...
    it('should handle empty autoclickers array', () => {
      jest.doMock('../../src/scripts/Systems/autoclickers.js', () => ({ autoclickers: [] }));
      jest.resetModules();
      const { DoroClicker: FreshDoroClicker } = require('../../src/scripts/Core/doroclicker.js');
  ...
  describe('performance', () => {
    it('should handle large autoclickers array efficiently', () => {
      const largeAutoclickers = Array(100).fill().map((_, i) => ({
        id: i + 100,
        name: `Doro ${i}`,
        baseCost: 100 + i,
        baseDPS: 10 + i,
  ...
  it('should remove all event listeners', () => {
    doroClicker.destroy();
    expect(doroClicker.events.removeAllEventListeners).toHaveBeenCalledTimes(1);
  });
